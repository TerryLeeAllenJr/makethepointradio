...
Developed by: Lee Allen
URL: http://www.lee-allen.com/
*/
...
function custom_post_shows() {
    ...
    register_post_type( 'shows', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        ...
        array( 'labels' => array(
            ...
            'description' => __( 'This is where you create and edit your lineup.', 'bonestheme' ), /* Custom Type Description */
            'public' => true,
            ...
            'menu_icon' => get_stylesheet_directory_uri() . '/library/images/shows-icon.png', /* the icon for the custom post type menu */
            'rewrite'	=> array( 'slug' => 'shows', 'with_front' => false ), /* you can specify its url slug */
...
add_action( 'init', 'custom_post_shows');
...
/*
    ...
    check out this ftch/Custom-Metaboxes-and-Fields-for-WordPressantastic tool:
    https://github.com/jareda
*/
